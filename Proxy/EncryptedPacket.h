...
#ifndef ENCRYPTEDPACKET_H
#define ENCRYPTEDPACKET_H
...
public:
	...
	EncryptedPacket(ByteBuffer &copyMe) : ByteBuffer(copyMe)
	{
	}
	...
	ByteBuffer toCipherText(CryptoPP::CBC_Mode<CryptoPP::Twofish>::Encryption *encryptor);
};
